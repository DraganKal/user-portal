...
public class LoginAttemptService {
    ...
    private LoadingCache<String, Integer> loginAttemptCache; //String predstavlja username, Integer predstavlja broj pokusaja
    ...
    public void removeUserFromLoginAttemptCache(String username) {
        loginAttemptCache.invalidate(username);                  //ova metoda brise korisnika iz memorije
    }
